namespace OpenLawOffice.Data.Mappings.Matters
{
    ...
    [Common.Models.MapMe]
    internal class MatterTag
    {
        internal void BuildMappings()
        {
            Mapper.CreateMap<DbModels.MatterTag, Common.Models.Matters.MatterTag>()
            ...
            Mapper.CreateMap<Common.Models.Matters.MatterTag, DbModels.MatterTag>()
                .ForMember(dst => dst.UtcCreated, opt => opt.MapFrom(src => src.UtcCreated))
                .ForMember(dst => dst.UtcModified, opt => opt.MapFrom(src => src.UtcModified))
                .ForMember(dst => dst.UtcDisabled, opt => opt.MapFrom(src => src.UtcDisabled))
