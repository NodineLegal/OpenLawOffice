...
namespace OpenLawOffice.Data.Mappings.Tasks
{
    ...
    /// </summary>
    [Common.Models.MapMe]
    internal class TaskResponsibleUser
    {
        internal void BuildMappings()
        {
            Mapper.CreateMap<DbModels.TaskResponsibleUser, Common.Models.Tasks.TaskResponsibleUser>()
            ...
            Mapper.CreateMap<Common.Models.Tasks.TaskResponsibleUser, DbModels.TaskResponsibleUser>()
                .ForMember(dst => dst.UtcCreated, opt => opt.MapFrom(src => src.UtcCreated))
                .ForMember(dst => dst.UtcModified, opt => opt.MapFrom(src => src.UtcModified))
                .ForMember(dst => dst.UtcDisabled, opt => opt.MapFrom(src => src.UtcDisabled))
