...
namespace OpenLawOffice.Data.Mappings.Timing
{
    using System;
    using AutoMapper;
    ...
    internal class Time
    {
        ...
        {
            Mapper.CreateMap<DbModels.Time, Common.Models.Timing.Time>()
            ...
            Mapper.CreateMap<Common.Models.Timing.Time, DbModels.Time>()
                .ForMember(dst => dst.UtcCreated, opt => opt.MapFrom(src => src.UtcCreated))
                .ForMember(dst => dst.UtcModified, opt => opt.MapFrom(src => src.UtcModified))
                .ForMember(dst => dst.UtcDisabled, opt => opt.MapFrom(src => src.UtcDisabled))
