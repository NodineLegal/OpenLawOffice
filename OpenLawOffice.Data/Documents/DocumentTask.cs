    ...
    public static class DocumentTask
    {
            ...
            Common.Models.Security.User creator)
        {
            ...
            using (IDbConnection conn = Database.Instance.GetConnection())
            {
                ...
                { // Update
                    conn.Execute("UPDATE \"document_task\" SET \"utc_modified\"=@UtcModified, \"modified_by_user_id\"=@ModifiedByUserId " +
                ...
                { // Create
                    conn.Execute("INSERT INTO \"document_task\" (\"id\", \"document_id\", \"task_id\", \"utc_created\", \"utc_modified\", \"created_by_user_id\", \"modified_by_user_id\") " +
