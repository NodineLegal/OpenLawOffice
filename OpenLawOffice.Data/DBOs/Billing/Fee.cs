...
namespace OpenLawOffice.Data.DBOs.Billing
{
    ...
    public class Fee : Core
    {
        ...
        {
            Dapper.SqlMapper.SetTypeMap(typeof(Fee), new ColumnAttributeTypeMapper<Fee>());
            Mapper.CreateMap<DBOs.Billing.Fee, Common.Models.Billing.Fee>()
            ...
            Mapper.CreateMap<Common.Models.Billing.Fee, DBOs.Billing.Fee>()
