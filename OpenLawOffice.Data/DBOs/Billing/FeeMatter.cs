// -----------------------------------------------------------------------
// <copyright file="FeeMatter.cs" company="Nodine Legal, LLC">
...
namespace OpenLawOffice.Data.DBOs.Billing
{
    ...
    public class FeeMatter : Core
    {
        ...
        {
            Dapper.SqlMapper.SetTypeMap(typeof(FeeMatter), new ColumnAttributeTypeMapper<FeeMatter>());
            Mapper.CreateMap<DBOs.Billing.FeeMatter, Common.Models.Billing.FeeMatter>()
            ...
            Mapper.CreateMap<Common.Models.Billing.FeeMatter, DBOs.Billing.FeeMatter>()
