...
namespace OpenLawOffice.Data.DBOs.Billing
{
    ...
    [Common.Models.MapMe]
    public class Expense : Core
    {
        [ColumnMapping(Name = "id")]
        public Guid Id { get; set; }

        [ColumnMapping(Name = "incurred")]
        public DateTime Incurred { get; set; }

        [ColumnMapping(Name = "paid")]
        public DateTime? Paid { get; set; }

        [ColumnMapping(Name = "vendor")]
        ...
        {
            Dapper.SqlMapper.SetTypeMap(typeof(Expense), new ColumnAttributeTypeMapper<Expense>());
            Mapper.CreateMap<DBOs.Billing.Expense, Common.Models.Billing.Expense>()
            ...
            Mapper.CreateMap<Common.Models.Billing.Expense, DBOs.Billing.Expense>()
