...
namespace OpenLawOffice.Data.DBOs.Billing
{
    ...
    public class BillingRate : Core
    {
        ...
        {
            Dapper.SqlMapper.SetTypeMap(typeof(BillingRate), new ColumnAttributeTypeMapper<BillingRate>());
            Mapper.CreateMap<DBOs.Billing.BillingRate, Common.Models.Billing.BillingRate>()
            ...
            Mapper.CreateMap<Common.Models.Billing.BillingRate, DBOs.Billing.BillingRate>()
