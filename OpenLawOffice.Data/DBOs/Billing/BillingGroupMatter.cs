// -----------------------------------------------------------------------
// <copyright file="BillingGroupMatter.cs" company="Nodine Legal, LLC">
...
namespace OpenLawOffice.Data.DBOs.Billing
{
    ...
    [Common.Models.MapMe]
    public class BillingGroupMatter : Core
    {
        ...
        {
            Dapper.SqlMapper.SetTypeMap(typeof(BillingGroupMatter), new ColumnAttributeTypeMapper<BillingGroupMatter>());
            Mapper.CreateMap<DBOs.Billing.BillingGroupMatter, Common.Models.Billing.BillingGroupMatter>()
            ...
            Mapper.CreateMap<Common.Models.Billing.ExpenseMatter, DBOs.Billing.ExpenseMatter>()
