...
namespace OpenLawOffice.Data.DBOs.Billing
{
    ...
    public class BillingGroup : Core
    {
        ...
        {
            Dapper.SqlMapper.SetTypeMap(typeof(BillingGroup), new ColumnAttributeTypeMapper<BillingGroup>());
            Mapper.CreateMap<DBOs.Billing.BillingGroup, Common.Models.Billing.BillingGroup>()
