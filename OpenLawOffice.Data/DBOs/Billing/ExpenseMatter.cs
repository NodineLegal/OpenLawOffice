...
namespace OpenLawOffice.Data.DBOs.Billing
{
    ...
    [Common.Models.MapMe]
    public class ExpenseMatter : Core
    {
        ...
        {
            Dapper.SqlMapper.SetTypeMap(typeof(ExpenseMatter), new ColumnAttributeTypeMapper<ExpenseMatter>());
            Mapper.CreateMap<DBOs.Billing.ExpenseMatter, Common.Models.Billing.ExpenseMatter>()
