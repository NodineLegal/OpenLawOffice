...
namespace OpenLawOffice.Data.DBOs.Forms
{
    ...
    public class FormField : Core
    {
        ...
        {
            Dapper.SqlMapper.SetTypeMap(typeof(FormField), new ColumnAttributeTypeMapper<FormField>());
            Mapper.CreateMap<DBOs.Forms.FormField, Common.Models.Forms.FormField>()
            ...
            Mapper.CreateMap<Common.Models.Forms.FormField, DBOs.Forms.FormField>()
