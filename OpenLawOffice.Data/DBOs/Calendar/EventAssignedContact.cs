...
namespace OpenLawOffice.Data.DBOs.Calendar
{
    ...
    public class EventAssignedContact : Core
    {
        ...
        public void BuildMappings()
        {
            ...
            Mapper.CreateMap<DBOs.Calendar.EventAssignedContact, Common.Models.Calendar.EventAssignedContact>()
            ...
            Mapper.CreateMap<Common.Models.Calendar.EventAssignedContact, DBOs.Calendar.EventAssignedContact>()
                .ForMember(dst => dst.UtcCreated, opt => opt.MapFrom(src => src.UtcCreated))
                .ForMember(dst => dst.UtcModified, opt => opt.MapFrom(src => src.UtcModified))
                .ForMember(dst => dst.UtcDisabled, opt => opt.MapFrom(src => src.UtcDisabled))
