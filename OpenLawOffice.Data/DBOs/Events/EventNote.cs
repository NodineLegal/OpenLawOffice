...
namespace OpenLawOffice.Data.DBOs.Events
{
    ...
    public class EventNote : Core
    {
        ...
        {
            Dapper.SqlMapper.SetTypeMap(typeof(EventNote), new ColumnAttributeTypeMapper<EventNote>());
            Mapper.CreateMap<DBOs.Events.EventNote, Common.Models.Events.EventNote>()
            ...
            Mapper.CreateMap<Common.Models.Events.EventNote, DBOs.Events.EventNote>()
                ...
                .ForMember(dst => dst.EventId, opt => opt.ResolveUsing(db =>
                {
                    return db.Event.Id.Value;
                }));
        }
    }
}
