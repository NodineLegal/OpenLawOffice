...
namespace OpenLawOffice.Data.DBOs.Notes
{
    ...
    public class NoteMatter : Core
    {
        ...
        {
            Dapper.SqlMapper.SetTypeMap(typeof(NoteMatter), new ColumnAttributeTypeMapper<NoteMatter>());
            Mapper.CreateMap<DBOs.Notes.NoteMatter, Common.Models.Notes.NoteMatter>()
            ...
            Mapper.CreateMap<Common.Models.Notes.NoteMatter, DBOs.Notes.NoteMatter>()
                .ForMember(dst => dst.UtcCreated, opt => opt.MapFrom(src => src.UtcCreated))
                .ForMember(dst => dst.UtcModified, opt => opt.MapFrom(src => src.UtcModified))
                .ForMember(dst => dst.UtcDisabled, opt => opt.MapFrom(src => src.UtcDisabled))
