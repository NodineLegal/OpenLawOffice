...
namespace OpenLawOffice.Data.DBOs.Documents
{
    ...
    public class DocumentTask : Core
    {
        ...
        {
            Dapper.SqlMapper.SetTypeMap(typeof(DocumentTask), new ColumnAttributeTypeMapper<DocumentTask>());
            Mapper.CreateMap<DBOs.Documents.DocumentTask, Common.Models.Documents.DocumentTask>()
            ...
            Mapper.CreateMap<Common.Models.Documents.DocumentTask, DBOs.Documents.DocumentTask>()
                .ForMember(dst => dst.UtcCreated, opt => opt.MapFrom(src => src.UtcCreated))
                .ForMember(dst => dst.UtcModified, opt => opt.MapFrom(src => src.UtcModified))
                .ForMember(dst => dst.UtcDisabled, opt => opt.MapFrom(src => src.UtcDisabled))
                ...
                .ForMember(dst => dst.TaskId, opt => opt.ResolveUsing(db =>
                {
                    return db.Task.Id.Value;
                }));
        }
    }
}
