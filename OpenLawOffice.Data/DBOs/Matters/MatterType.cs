...
namespace OpenLawOffice.Data.DBOs.Matters
{
    ...
    public class MatterType : Core
    {
        ...
        {
            Dapper.SqlMapper.SetTypeMap(typeof(MatterType), new ColumnAttributeTypeMapper<MatterType>());
            Mapper.CreateMap<DBOs.Matters.MatterType, Common.Models.Matters.MatterType>()
            ...
            Mapper.CreateMap<Common.Models.Matters.MatterType, DBOs.Matters.MatterType>()
