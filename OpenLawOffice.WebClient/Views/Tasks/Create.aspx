...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="detail_table">
        ...
        <tr>
            <td class="display-label">Group</td>
            <td class="display-field">
                <%: Html.CheckBoxFor(model => model.IsGroupingTask) %>
                Would you like to make this task a grouping task?  A grouping task is capable 
                of having subtasks and will automatically calculate it's own projected start, end, due and
                actual end dates.
            </td>
        </tr>
        <tr>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MenuContent" runat="server">
    ...
    <li><%: Html.ActionLink("Tasks", "Tasks", "Matters", new { id = ViewData["MatterId"] }, null) %></li>
</asp:Content>
