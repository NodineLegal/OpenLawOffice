...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="detail_table">
        ...
        <tr>
            ...
            <td class="display-field"><%: Model.User.Username %></td>
        </tr>
        <tr>
            <td class="display-label">Responsiblity</td>
            <td class="display-field"><%: Model.Responsibility %></td>
        </tr>
    </table>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MenuContent" runat="server">
    ...
    <ul style="list-style: none outside none; padding-left: 1em;">
        ...
        <li><%: Html.ActionLink("List", "ResponsibleUsers", "Tasks", new { id = Model.Task.Id }, null)%></li>
    </ul>
</asp:Content>
