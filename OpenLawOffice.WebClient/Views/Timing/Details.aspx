...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="detail_table">
        ...
        <tr>
            ...
            <td class="display-field">
                <%: String.Format("{0:g}", DateTime.SpecifyKind(Model.Start, DateTimeKind.Utc).ToLocalTime())%>
            </td>
        </tr>
        <tr>
            <td class="display-label">
            ...
            <td class="display-field">
                <%: String.Format("{0:g}", DateTime.SpecifyKind(Model.Stop.Value, DateTimeKind.Utc).ToLocalTime())%>
            </td>
        </tr>
        <tr>
            <td class="display-label">
