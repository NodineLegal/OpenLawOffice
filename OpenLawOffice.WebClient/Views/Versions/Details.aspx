...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="detail_table">
        ...
        <tr>
            <td class="display-label">Document</td>
            <td class="display-field"><%: Model.Document.Title %></td>
        </tr>
        <tr>
            <td class="display-label">Version</td>
            <td class="display-field"><%: Model.VersionNumber%></td>
        </tr>
        <tr>
            <td class="display-label">Mime</td>
            <td class="display-field"><%: Model.Mime%></td>
        </tr>
        <tr>
            <td class="display-label">Filename</td>
            <td class="display-field"><%: Model.Filename%></td>
        </tr>
        <tr>
            <td class="display-label">Extension</td>
            <td class="display-field"><%: Model.Extension%></td>
        </tr>
        <tr>
            <td class="display-label">Size</td>
            <td class="display-field"><%: Model.Size %></td>
        </tr>
        <tr>
            <td class="display-label">MD5 Checksum</td>
            <td class="display-field"><%: Model.Md5 %></td>
        </tr>
    </table>
