namespace OpenLawOffice.WebClient.Installation
{
    using System;
    using System.Data;
    ...
    public class Database
    {
        public void Run()
        {
            using (IDbConnection conn = WebClient.Database.Instance.OpenConnection())
            {
                ...
                string pw = WebClient.Security.ServerHashPassword("1F40FC92DA241694750979EE6CF582F2D5D7D28E18335DE05ABC54D0560E0F5302860C652BF08D560252AA5E74210546F369FBBBCE8C12CFC7957B2652FE9A75", "0123456789");
                ...
                if (dbUser == null)
                {
                    ...
                    dbUser.Id = (int)conn.LastInsertId();
                }

                #region Areas

                DBOs.Security.Area dbSecurity = conn.Single<DBOs.Security.Area>(new { Name = "Security" });
                if (dbSecurity == null)
                {
                    ...
                    dbSecurity.Id = (int)conn.LastInsertId();
                }

                DBOs.Security.Area dbAreaUser = conn.Single<DBOs.Security.Area>(new { Name = "Security.User" });
                if (dbAreaUser == null)
                {
                    ...
                    dbAreaUser.Id = (int)conn.LastInsertId();
                }

                DBOs.Security.Area dbAreaArea = conn.Single<DBOs.Security.Area>(new { Name = "Security.Area" });
                if (dbAreaArea == null)
                {
                    ...
                    dbAreaArea.Id = (int)conn.LastInsertId();
                }

                DBOs.Security.Area dbAreaAreaAcl = conn.Single<DBOs.Security.Area>(new { Name = "Security.AreaAcl" });
                if (dbAreaAreaAcl == null)
                {
                    ...
                    dbAreaAreaAcl.Id = (int)conn.LastInsertId();
                }

                DBOs.Security.Area dbAreaSecuredResource = conn.Single<DBOs.Security.Area>(new { Name = "Security.SecuredResource" });
                if (dbAreaSecuredResource == null)
                {
                    ...
                    dbAreaSecuredResource.Id = (int)conn.LastInsertId();
                }

                DBOs.Security.Area dbAreaSecuredResourceAcl = conn.Single<DBOs.Security.Area>(new { Name = "Security.SecuredResourceAcl" });
                if (dbAreaSecuredResourceAcl == null)
                {
                    ...
                    dbAreaSecuredResourceAcl.Id = (int)conn.LastInsertId();
                }

                DBOs.Security.Area dbAreaTagging = conn.Single<DBOs.Security.Area>(new { Name = "Tagging" });
                if (dbAreaTagging == null)
                {
                    ...
                    dbAreaTagging.Id = (int)conn.LastInsertId();
                }

                DBOs.Security.Area dbAreaTaggingTagCategory = conn.Single<DBOs.Security.Area>(new { Name = "Tagging.TagCategory" });
                if (dbAreaTaggingTagCategory == null)
                {
                    ...
                    dbAreaTaggingTagCategory.Id = (int)conn.LastInsertId();
                }

                DBOs.Security.Area dbAreaMatters = conn.Single<DBOs.Security.Area>(new { Name = "Matters" });
                if (dbAreaMatters == null)
                {
                    ...
                    dbAreaMatters.Id = (int)conn.LastInsertId();
                }

                DBOs.Security.Area dbAreaMattersMatter = conn.Single<DBOs.Security.Area>(new { Name = "Matters.Matter" });
                if (dbAreaMattersMatter == null)
                {
                    ...
                    dbAreaMattersMatter.Id = (int)conn.LastInsertId();
                }

                DBOs.Security.Area dbAreaMattersTag = conn.Single<DBOs.Security.Area>(new { Name = "Matters.MatterTag" });
                if (dbAreaMattersTag == null)
                {
                    ...
                    dbAreaMattersTag.Id = (int)conn.LastInsertId();
                }

                DBOs.Security.Area dbAreaMattersResponsibleUser = conn.Single<DBOs.Security.Area>(new { Name = "Matters.ResponsibleUser" });
                if (dbAreaMattersResponsibleUser == null)
                {
                    ...
                    dbAreaMattersResponsibleUser.Id = (int)conn.LastInsertId();
                }

                DBOs.Security.Area dbAreaMattersMatterContact = conn.Single<DBOs.Security.Area>(new { Name = "Matters.MatterContact" });
                if (dbAreaMattersMatterContact == null)
                {
                    ...
                    dbAreaMattersMatterContact.Id = (int)conn.LastInsertId();
                }

                DBOs.Security.Area dbAreaContacts = conn.Single<DBOs.Security.Area>(new { Name = "Contacts" });
                if (dbAreaContacts == null)
                {
                    ...
                    dbAreaContacts.Id = (int)conn.LastInsertId();
                }

                DBOs.Security.Area dbAreaContactsContact = conn.Single<DBOs.Security.Area>(new { Name = "Contacts.Contact" });
                if (dbAreaContactsContact == null)
                {
                    ...
                    dbAreaContactsContact.Id = (int)conn.LastInsertId();
                }

                DBOs.Security.Area dbAreaTasks = conn.Single<DBOs.Security.Area>(new { Name = "Tasks" });
                if (dbAreaTasks == null)
                {
                    ...
                    dbAreaTasks.Id = (int)conn.LastInsertId();
                }

                DBOs.Security.Area dbAreaTasksTask = conn.Single<DBOs.Security.Area>(new { Name = "Tasks.Task" });
                if (dbAreaTasksTask == null)
                {
                    ...
                    dbAreaTasksTask.Id = (int)conn.LastInsertId();
                }

                DBOs.Security.Area dbAreaTasksTaskAssignedContact = conn.Single<DBOs.Security.Area>(new { Name = "Tasks.TaskAssignedContact" });
                if (dbAreaTasksTaskAssignedContact == null)
                {
                    ...
                    dbAreaTasksTaskAssignedContact.Id = (int)conn.LastInsertId();
                }

                DBOs.Security.Area dbAreaTasksTaskMatter = conn.Single<DBOs.Security.Area>(new { Name = "Tasks.TaskMatter" });
                if (dbAreaTasksTaskMatter == null)
                {
                    ...
                    dbAreaTasksTaskMatter.Id = (int)conn.LastInsertId();
                }

                DBOs.Security.Area dbAreaTasksTaskResponsibleUser = conn.Single<DBOs.Security.Area>(new { Name = "Tasks.TaskResponsibleUser" });
                if (dbAreaTasksTaskResponsibleUser == null)
                {
                    ...
                    dbAreaTasksTaskResponsibleUser.Id = (int)conn.LastInsertId();
                }

                DBOs.Security.Area dbAreaTasksTaskTag = conn.Single<DBOs.Security.Area>(new { Name = "Tasks.TaskTag" });
                if (dbAreaTasksTaskTag == null)
                {
                    ...
                    dbAreaTasksTaskTag.Id = (int)conn.LastInsertId();
                }

                DBOs.Security.Area dbAreaTasksTaskTime = conn.Single<DBOs.Security.Area>(new { Name = "Tasks.TaskTime" });
                if (dbAreaTasksTaskTime == null)
                {
                    ...
                    dbAreaTasksTaskTime.Id = (int)conn.LastInsertId();
                }

                DBOs.Security.Area dbAreaTiming = conn.Single<DBOs.Security.Area>(new { Name = "Timing" });
                if (dbAreaTiming == null)
                {
                    ...
                    dbAreaTiming.Id = (int)conn.LastInsertId();
                }

                DBOs.Security.Area dbAreaTimingTime = conn.Single<DBOs.Security.Area>(new { Name = "Timing.Time" });
                if (dbAreaTimingTime == null)
                {
                    ...
                    dbAreaTimingTime.Id = (int)conn.LastInsertId();
                }
                ...
                DBOs.Security.AreaAcl dbAAclSecurity = conn.Single<DBOs.Security.AreaAcl>(new { SecurityAreaId = dbSecurity.Id, UserId = dbUser.Id });
                if (dbAAclSecurity == null)
                {
                    ...
                    dbAAclSecurity.Id = (int)conn.LastInsertId();
                }

                DBOs.Security.AreaAcl dbAAclUser = conn.Single<DBOs.Security.AreaAcl>(new { SecurityAreaId = dbAreaUser.Id, UserId = dbUser.Id });
                if (dbAAclUser == null)
                {
                    ...
                    dbAAclUser.Id = (int)conn.LastInsertId();
                }

                DBOs.Security.AreaAcl dbAAclArea = conn.Single<DBOs.Security.AreaAcl>(new { SecurityAreaId = dbAreaArea.Id, UserId = dbUser.Id });
                if (dbAAclArea == null)
                {
                    ...
                    dbAAclArea.Id = (int)conn.LastInsertId();
                }

                DBOs.Security.AreaAcl dbAAclAreaAcl = conn.Single<DBOs.Security.AreaAcl>(new { SecurityAreaId = dbAreaAreaAcl.Id, UserId = dbUser.Id });
                if (dbAAclAreaAcl == null)
                {
                    ...
                    dbAAclAreaAcl.Id = (int)conn.LastInsertId();
                }

                DBOs.Security.AreaAcl dbAAclSecuredResource = conn.Single<DBOs.Security.AreaAcl>(new { SecurityAreaId = dbAreaSecuredResource.Id, UserId = dbUser.Id });
                if (dbAAclSecuredResource == null)
                {
                    ...
                    dbAAclSecuredResource.Id = (int)conn.LastInsertId();
                }

                DBOs.Security.AreaAcl dbAAclSecuredResourceAcl = conn.Single<DBOs.Security.AreaAcl>(new { SecurityAreaId = dbAreaSecuredResourceAcl.Id, UserId = dbUser.Id });
                if (dbAAclSecuredResourceAcl == null)
                {
                    ...
                    dbAAclSecuredResourceAcl.Id = (int)conn.LastInsertId();
                }

                // Matters
                DBOs.Security.AreaAcl dbAAclMatters = conn.Single<DBOs.Security.AreaAcl>(new { SecurityAreaId = dbAreaMatters.Id, UserId = dbUser.Id });
                if (dbAAclMatters == null)
                {
                    ...
                    dbAAclMatters.Id = (int)conn.LastInsertId();
                }

                // Tagging.TagCategory
                DBOs.Security.AreaAcl dbAAclTaggingTagCategory = conn.Single<DBOs.Security.AreaAcl>(new { SecurityAreaId = dbAreaTaggingTagCategory.Id, UserId = dbUser.Id });
                if (dbAAclTaggingTagCategory == null)
                {
                    ...
                    dbAAclTaggingTagCategory.Id = (int)conn.LastInsertId();
                }

                // Matters.Matter
                DBOs.Security.AreaAcl dbAAclMattersMatter = conn.Single<DBOs.Security.AreaAcl>(new { SecurityAreaId = dbAreaMattersMatter.Id, UserId = dbUser.Id });
                if (dbAAclMattersMatter == null)
                {
                    ...
                    dbAAclMattersMatter.Id = (int)conn.LastInsertId();
                }

                // Matters.MatterTag
                DBOs.Security.AreaAcl dbAAclMattersMatterTag = conn.Single<DBOs.Security.AreaAcl>(new { SecurityAreaId = dbAreaMattersTag.Id, UserId = dbUser.Id });
                if (dbAAclMattersMatterTag == null)
                {
                    ...
                    dbAAclMattersMatterTag.Id = (int)conn.LastInsertId();
                }

                // Matters.ResponsibleUser
                DBOs.Security.AreaAcl dbAAclMattersResponsibleUser = conn.Single<DBOs.Security.AreaAcl>(new { SecurityAreaId = dbAreaMattersResponsibleUser.Id, UserId = dbUser.Id });
                if (dbAAclMattersResponsibleUser == null)
                {
                    ...
                    dbAAclMattersResponsibleUser.Id = (int)conn.LastInsertId();
                }

                // Matters.MatterContact
                DBOs.Security.AreaAcl dbAAclMattersMatterContact = conn.Single<DBOs.Security.AreaAcl>(new { SecurityAreaId = dbAreaMattersMatterContact.Id, UserId = dbUser.Id });
                if (dbAAclMattersMatterContact == null)
                {
                    ...
                    dbAAclMattersMatterContact.Id = (int)conn.LastInsertId();
                }

                // Contacts
                DBOs.Security.AreaAcl dbAAclContacts = conn.Single<DBOs.Security.AreaAcl>(new { SecurityAreaId = dbAreaContacts.Id, UserId = dbUser.Id });
                if (dbAAclContacts == null)
                {
                    ...
                    dbAAclContacts.Id = (int)conn.LastInsertId();
                }

                // Contacts.Contact
                DBOs.Security.AreaAcl dbAAclContactsContact = conn.Single<DBOs.Security.AreaAcl>(new { SecurityAreaId = dbAreaContactsContact.Id, UserId = dbUser.Id });
                if (dbAAclContactsContact == null)
                {
                    ...
                    dbAAclContactsContact.Id = (int)conn.LastInsertId();
                }

                // Tasks
                DBOs.Security.AreaAcl dbAAclTasks = conn.Single<DBOs.Security.AreaAcl>(new { SecurityAreaId = dbAreaTasks.Id, UserId = dbUser.Id });
                if (dbAAclTasks == null)
                {
                    ...
                    dbAAclTasks.Id = (int)conn.LastInsertId();
                }

                // Tasks.Task
                DBOs.Security.AreaAcl dbAAclTasksTask = conn.Single<DBOs.Security.AreaAcl>(new { SecurityAreaId = dbAreaTasksTask.Id, UserId = dbUser.Id });
                ...
                // Tasks.TaskMatter
                DBOs.Security.AreaAcl dbAAclTasksTaskMatter = conn.Single<DBOs.Security.AreaAcl>(new { SecurityAreaId = dbAreaTasksTaskMatter.Id, UserId = dbUser.Id });
                if (dbAAclTasksTaskMatter == null)
                {
                    ...
                    dbAAclTasksTaskMatter.Id = (int)conn.LastInsertId();
                }

                // Tasks.TaskResponsibleUser
                DBOs.Security.AreaAcl dbAAclTasksTaskResponsibleUser = conn.Single<DBOs.Security.AreaAcl>(new { SecurityAreaId = dbAreaTasksTaskResponsibleUser.Id, UserId = dbUser.Id });
                if (dbAAclTasksTask == null)
                {
                    ...
                    dbAAclTasksTaskResponsibleUser.Id = (int)conn.LastInsertId();
                }

                // Tasks.TaskTag
                DBOs.Security.AreaAcl dbAAclTasksTaskTag = conn.Single<DBOs.Security.AreaAcl>(new { SecurityAreaId = dbAreaTasksTaskTag.Id, UserId = dbUser.Id });
                if (dbAAclTasksTaskTag == null)
                {
                    ...
                    dbAAclTasksTaskTag.Id = (int)conn.LastInsertId();
                }

                // Tasks.TaskTime
                DBOs.Security.AreaAcl dbAAclTasksTaskTime = conn.Single<DBOs.Security.AreaAcl>(new { SecurityAreaId = dbAreaTasksTaskTime.Id, UserId = dbUser.Id });
                if (dbAAclTasksTaskTime == null)
                {
                    ...
                    dbAAclTasksTaskTime.Id = (int)conn.LastInsertId();
                }

                // Timing
                DBOs.Security.AreaAcl dbAAclTiming = conn.Single<DBOs.Security.AreaAcl>(new { SecurityAreaId = dbAreaTiming.Id, UserId = dbUser.Id });
                if (dbAAclTiming == null)
                {
                    ...
                    dbAAclTiming.Id = (int)conn.LastInsertId();
                }

                // Timing.Time
                DBOs.Security.AreaAcl dbAAclTimingTime = conn.Single<DBOs.Security.AreaAcl>(new { SecurityAreaId = dbAreaTimingTime.Id, UserId = dbUser.Id });
                if (dbAAclTimingTime == null)
                {
                    ...
                    dbAAclTimingTime.Id = (int)conn.LastInsertId();
                }
                ...
                DBOs.Contacts.Contact dbContact = conn.Single<DBOs.Contacts.Contact>(new { DisplayName = "Lucas Nodine" });
                if (dbContact == null)
                {
                    ...
                    dbContact.Id = (int)conn.LastInsertId();
                }
                ...
                DBOs.Tagging.TagCategory dbTagCategory1 = conn.Single<DBOs.Tagging.TagCategory>(new { Name = "Status" });
                if (dbTagCategory1 == null)
                {
                    ...
                    dbTagCategory1.Id = (int)conn.LastInsertId();
                }

                DBOs.Tagging.TagCategory tagCategory2 = conn.Single<DBOs.Tagging.TagCategory>(new { Name = "Jurisdiction" });
                if (tagCategory2 == null)
                {
                    ...
                    tagCategory2.Id = (int)conn.LastInsertId();
                }

                DBOs.Matters.Matter matter1 = conn.Single<DBOs.Matters.Matter>(new { Title = "Test Matter 1" });
                if (matter1 == null)
                {
                ...
                DBOs.Security.SecuredResource secRes1 = conn.Single<DBOs.Security.SecuredResource>(new { Id = matter1.Id });
                if (secRes1 == null)
                {
                ...
                DBOs.Security.SecuredResourceAcl secResAcl1 = conn.Single<DBOs.Security.SecuredResourceAcl>(new { SecuredResourceId = secRes1.Id, UserId = dbUser.Id });
                if (secResAcl1 == null)
                {
                ...
                DBOs.Matters.MatterTag matterTag1 = conn.Single<DBOs.Matters.MatterTag>(new { Tag = "Active" });
                if (matterTag1 == null)
                {
                ...
                DBOs.Matters.MatterTag matterTag2 = conn.Single<DBOs.Matters.MatterTag>(new { Tag = "Labette County, KS" });
                if (matterTag2 == null)
                {
                ...
                DBOs.Matters.ResponsibleUser respUser1 = conn.Single<DBOs.Matters.ResponsibleUser>(new { MatterId = matter1.Id, UserId = dbUser.Id });
                if (respUser1 == null)
                {
                    ...
                    respUser1.Id = (int)conn.LastInsertId();
                }

                DBOs.Matters.MatterContact matterContact1 = conn.Single<DBOs.Matters.MatterContact>(new { MatterId = matter1.Id, ContactId = dbContact.Id });
                if (matterContact1 == null)
                {
                    ...
                    matterContact1.Id = (int)conn.LastInsertId();
                }
                ...
                DBOs.Timing.Time time1 = conn.Single<DBOs.Timing.Time>(new { Id = Guid.Parse("f1220521-20d6-4544-9438-d664d8719935") });
                if (time1 == null)
                {
                ...
                DBOs.Tasks.Task task1 = conn.Single<DBOs.Tasks.Task>(new { Title = "Test Task 1" });
                if (task1 == null)
                {
                    ...
                    task1.Id = conn.LastInsertId();
                }

                DBOs.Tasks.TaskAssignedContact taskAssignedContact1 = conn.Single<DBOs.Tasks.TaskAssignedContact>(new { TaskId = task1.Id, ContactId = dbContact.Id });
                ...
                DBOs.Tasks.TaskMatter taskMatter1 = conn.Single<DBOs.Tasks.TaskMatter>(new { TaskId = task1.Id, MatterId = matter1.Id });
                if (taskMatter1 == null)
                {
                ...
                DBOs.Tasks.TaskResponsibleUser taskRespUser1 = conn.Single<DBOs.Tasks.TaskResponsibleUser>(new { TaskId = task1.Id, UserId = dbUser.Id });
                ...
                DBOs.Tagging.TagCategory dbTagCategory3 = conn.Single<DBOs.Tagging.TagCategory>(new { Name = "Priority" });
                if (dbTagCategory3 == null)
                {
                    ...
                    dbTagCategory3.Id = (int)conn.LastInsertId();
                }

                DBOs.Tasks.TaskTag taskTag1 = conn.Single<DBOs.Tasks.TaskTag>(new { Tag = "Pending" });
                if (taskTag1 == null)
                {
                ...
                DBOs.Tasks.TaskTag taskTag2 = conn.Single<DBOs.Tasks.TaskTag>(new { Tag = "High" });
                if (taskTag2 == null)
                {
                ...
                DBOs.Tasks.TaskTime taskTime1 = conn.Single<DBOs.Tasks.TaskTime>(new { TaskId = task1.Id, TimeId = time1.Id });
                if (taskTime1 == null)
                {
