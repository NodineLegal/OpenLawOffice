...
namespace OpenLawOffice.WebClient.Controllers
{
    ...
    public class InstallationController : Controller
    {
        ...
        private static void RequiredData(string installDirPath, bool runOptionalData = false)
        {
            ...
            if (user == null)
            {
                createStatus = membershipService.CreateUser("Administrator", "password", 
            ...
            if (!roleService.IsUserInRole("Administrator", "Login"))
            {
                roleService.AddUserToRole("Administrator", "Login");
            }

            if (!roleService.IsUserInRole("Administrator", "Admin"))
            {
                roleService.AddUserToRole("Administrator", "Admin");
            }
