// -----------------------------------------------------------------------
// <copyright file="TagFilterElement.cs" company="Nodine Legal, LLC">
...
namespace OpenLawOffice.Common.Settings
{
    ...
    /// TODO: Update summary.
    /// </summary>
    public class TagFilterElement : ConfigurationElement
    {
        ...
        public TagFilterElement()
        {
        }

        public TagFilterElement(string category, string tag)
        {
            Category = category;
            Tag = tag;
        }
